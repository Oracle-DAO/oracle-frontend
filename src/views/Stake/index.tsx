...
function Stake() {
    ...
    const nextRewardValue = trim((Number(stakingRebasePercentage) / 100) * Number(trimmedsOracleBalance), 6);
    return (
                                ...
                                <div>
                                    ...
                                    <div className="stake-user-data">
                                        ...
                                        <div className="data-row">
                                            ...
                                            <p className="data-row-value">{isAppLoading ? <Skeleton width="80px" /> : <>{nextRewardValue} sORCL</>}</p>
                                        </div>
