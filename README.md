# [Oracle Frontend]()
This is the front-end repo for Oracle DAO. 
...
```bash
git clone https://github.com/OracleDao/oracle-frontend.git
cd oracle-frontend
npm install
npm run start
```
...
*__NOTE__*: For big changes associated with feature releases/milestones, they will be merged onto the `stage` branch for more thorough QA before a final merge to `develop`
